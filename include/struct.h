...
struct s_mc_parms
{
	...
	int nreplicas; // if nreplicas==ntemp, load a different polymer for each replica; if nreplicas==1 load the same polymer for each replica
	char input_names[NREPMAX][30];
};
