                                  ...
                                  struct vector C, struct angles W, struct s_tables *tables, int *out)
{
  ...
  *out = 0;
  ...
  if (l_ab + l_bc -l_ac < EPSILON) { fprintf(stderr,"WARNING: BA and CB aligned in Spherical2Cartesian\n"); return Z; }
   
   // Check if they coincides
   if ( l_ab < EPSILON)  { fprintf(stderr,"WARNING: A and B overlapping in Spherical2Cartesian\n");  return Z; }
   if ( l_ac < EPSILON)  { fprintf(stderr,"WARNING: A and C overlapping in Spherical2Cartesian\n");  return Z; }
   if ( l_bc < EPSILON)  { fprintf(stderr,"WARNING: B and C overlapping in Spherical2Cartesian\n");  return Z; }
  ...
  if (l2<EPSILON)  { fprintf(stderr,"WARNING: l2=0 in Spherical2Cartesian\n");  return Z; } //PARANOID
  inv_l = 1. / l2;
  if (inv_l<EPSILON)  { fprintf(stderr,"WARNING: inv_l=0 in Spherical2Cartesian\n"); return Z; } //PARANOID
  ...
  if (l1<EPSILON)  { fprintf(stderr,"WARNING: l1=0 in Spherical2Cartesian\n"); return Z; } //PARANOID
  inv_l = 1. / l1;
  if (inv_l<EPSILON)  { fprintf(stderr,"WARNING: inv_l=0 Spherical2Cartesian\n"); return Z; } //PARANOID
